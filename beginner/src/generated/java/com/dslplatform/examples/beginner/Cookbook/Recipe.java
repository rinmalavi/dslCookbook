package com.dslplatform.examples.beginner.Cookbook;
...
public class Recipe implements java.io.Serializable, AggregateRoot {
    ...
    @JsonCreator private Recipe(
            ...
            @JsonProperty("ingredients") final String[] ingredients) {
    ...
    private void updateWithAnother(final com.dslplatform.examples.beginner.Cookbook.Recipe result) {
        this.URI = result.URI;
    ...
    public Recipe setIngredients(final String[] value) {
        ...
        com.dslplatform.examples.beginner.Guards.checkNulls(value);
        this.ingredients = value;

        return this;
    }

public static class isTheOld implements java.io.Serializable, Specification<Recipe> {
    public isTheOld() {}
...
public static class hasFlour implements java.io.Serializable, Specification<Recipe> {
    public hasFlour() {}
...
public static class hasNoPeanuts implements java.io.Serializable, Specification<Recipe> {
    public hasNoPeanuts() {}
