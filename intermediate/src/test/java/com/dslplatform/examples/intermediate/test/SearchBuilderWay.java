...
public class SearchBuilderWay extends OpenRestaurantInTest {
    ...
    public void searchRepository() throws Exception {
        ...
        SearchBuilder<MealInfo> sb = mealInfoRepository.builder().with(new MealInfo.budgetMeals(22)).limit(20).offset(0).ascending("name");
